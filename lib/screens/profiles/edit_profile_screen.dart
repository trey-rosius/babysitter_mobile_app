                                ...
                                child: ClipOval(
                                    child: ClipRRect(
                                        ...
                                        child: CachedNetworkImage(
                                            ...
                                            placeholder: (context,
                                                url) =>
                                                CircularProgressIndicator(valueColor: AlwaysStoppedAnimation<Color>(ThemeColor.primaryColor),),
                                            errorWidget: (context,
                                                url, ex) =>
                                                CircleAvatar(
                                                  backgroundColor:
                                ...
                                Container(
                                  ...
                                  decoration: const BoxDecoration(
                                    ...
                                    gradient: LinearGradient(
                                        ...
                                        colors: [ThemeColor.primaryColor,ThemeColor.secondary], // red to yellow
                                        tileMode: TileMode.clamp// repeats the gradient over the canvas
                                    ),
                                    borderRadius: BorderRadius.all(Radius.circular(10.0)),

                                  ),
                                  //  color: Theme.of(context).primaryColorColor,
